 ...
 * User will able to see the end-points to access the application.
 *
 */
@Configuration
...
public class SpringFoxConfig { 
	...
	/*
	 * The below method will provide details about
	 * title, desc, termsofservice, license, contact and the version
	 */
