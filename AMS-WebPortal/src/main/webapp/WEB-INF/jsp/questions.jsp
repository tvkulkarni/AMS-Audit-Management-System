...
<body>
	<nav class="navbar navbar-expand-lg navbar-light bg-light">
		<a class="navbar-brand" href="#"><b>AMS</b></a>
	...
	<div class="container">
		...
		<h3 class="m-4 display-6 text-center">${auditType.getAuditType()} Audit Questions</h3>
		
		<form:form action="/questions" method="post" 
			modelAttribute="questions" class="px-3 py-4 border rounded align-items-center">
			<c:forEach var="emp" items="${questions.questionsEntity}"
				...
				<form:label class="form-control"  style="width:50px;" path="questionsEntity[${status.index}].response">No</form:label>

				
				</div>

			</c:forEach>
			<input type="Submit" value="Submit" id="submit" class="btn btn-success btn-block mt-3" />
