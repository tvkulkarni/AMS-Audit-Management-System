...
public class AuditPortalController {
	 ...
	 // AuthClient: To verify the token.
	 // AuditCheckListProxy: To call  methods from other  AuditCheckList microservice.
	 // AuditSeverityProxy: To call  methods from other  AuditSeverity microservice.
